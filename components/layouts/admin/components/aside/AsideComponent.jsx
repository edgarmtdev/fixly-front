...
export default function AsideComponent() {
  ...
  return (
    <>
      {view && (
        <div
          className="absolute z-10 top-0 left-0 bg-[#00000078] h-[100vh] w-[100%]"
          onClick={() => setView(false)}
        ></div>
      )}
      <aside
        className={`bg-primary-100 h-[100vh] top-0 shadow z-30 ${
          view
            ? "translate-x-[0%] transition-all duration-200"
            : "translate-x-[-100%] transition-all duration-200"
